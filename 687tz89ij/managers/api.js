...
module.exports = (app) => {
	...
	app.get('/lightswitch/api/service/bulk/status', (req, res) => {
		res.json([{
			...
			"banned": req.headers.authorization.split('@')[1] == "NeoRiftBot"
		}]);
	});
	...
	app.get('/party/api/v1/Fortnite/user/:accountId/notifications/delivered/count', (req, res) => { res.status(204).end(); });
	...
	app.get('/fortnite/api/storefront/v2/keychain', (req, res) => {
		fetch('https://gd-fnapi.herokuapp.com/Keychain', {
  			method: 'GET'
		})
		.then(res1 => res1.json())
